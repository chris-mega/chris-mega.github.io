  ...
  return (
    <div className="flex flex-col gap-8 p-10">
      <div className="flex flex-col gap-4">
        <h1 className="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">FIRA 2018 Taiwan - Hurocup Kid Size</h1>
        <h2 className="text-xl font-semibold text-gray-500 dark:text-white lg:text-2xl">Robot olympics in Taiwan!</h2>
      </div>
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            No one knew exactly how to use it; other student volunteers with more experience had some ideas ported from the previous version, OP2, but the framework for OP3 is different, involving <b>ROS Kinetic</b>, publishers and subscribers and <b>C++</b>.
            Because I was getting paid by the award, I had times of being by myself there, trying to figure out how everything works and getting guidance on computer vision (<b>OpenCV</b>) and movement animation.
            There were a lot of trials and errors, but it was very fun. Finally, we could make it work.
          </p>

          <p>
            Unfortunately, but also luckily, the most experienced guy quit, so it allowed me to travel instead with another Kid-Size guy and two adult-size guys to Taichung, Taiwan. This was our{" "}
            <PostLink href="https://www.youtube.com/watch?v=GU-4sg2ITcE" >qualification video</PostLink>
          </p>

          <p>
            There was a lot of excitement! First time in Asia, representing Canada, seeing 3 months of work finally compete and getting to know people from all over the world.
            There were also some high expectations from us as <b>Snobots</b> (our official team name) has performed very well in the past years.
            Now the competition had more teams, old teams got strong, new sporting events were added but both me and my kid-size partner were new on this kind of competition using a new robot.
          </p>
